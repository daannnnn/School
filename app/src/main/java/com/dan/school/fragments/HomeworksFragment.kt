...
class HomeworksFragment(private val itemClickListener: ItemClickListener) : Fragment(), HomeworkListAdapter.DoneListener,
    HomeworkListAdapter.ShowSubtasksListener, HomeworkListAdapter.ItemClickListener {
